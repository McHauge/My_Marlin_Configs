 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, -50, -2 }
...
#define X_BED_SIZE 396 // Nozzle is at X4 when homed
#define Y_BED_SIZE 398 // Nozzle is at Y2 when homed

// Travel limits (mm) after homing, corresponding to endstop positions.
#define X_MIN_POS 4
#define Y_MIN_POS 2
#define Z_MIN_POS 0
#define X_MAX_POS 419 // 15mm Extra space on the right end
#define Y_MAX_POS 406 // 4mm Extra space behind the bed
...
#define LEVEL_BED_CORNERS
  ...
  #define LEVEL_CORNERS_INSET_LFRB { 30, 50, 30, 10 } // (mm) Left, Front, Right, Back insets
  #define LEVEL_CORNERS_HEIGHT      10.0   // (mm) Z height of nozzle at leveling points
